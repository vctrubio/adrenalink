export default function HeadsetIcon({ className = "", size = 24, rental = false }) {
    return (
        <svg width={size} height={size} className={rental ? "text-destructive" : className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
