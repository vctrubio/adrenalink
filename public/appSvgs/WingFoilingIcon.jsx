...
export default function WingFoilingIcon({ className = "w-6 h-6", ...props }) {
    return (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
            ...
            />
            {/* Wing handle */}
            <path d="M10 10L11 14" stroke="currentColor" strokeWidth="2" />
            {/* Rider */}
            <circle cx="11" cy="16" r="1.5" fill="currentColor" />
            {/* Board (smaller than kiteboard) */}
            <path d="M9 19L13 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
            {/* Hydrofoil mast */}
            <path d="M11 19L11 21" stroke="currentColor" strokeWidth="1.5" />
            {/* Hydrofoil wing */}
            <path d="M8 21L14 21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
            {/* Front foil */}
            <path d="M8 21L8 22" stroke="currentColor" strokeWidth="1.5" />
            <path d="M14 21L14 22" stroke="currentColor" strokeWidth="1.5" />
            {/* Water waves */}
            <path
