            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 justify-items-center divide-y md:divide-y-0 divide-blue-200/50">
                    <div className="w-full py-8 md:py-0">
                        <FeatureCard title="A Classboard" icon={<IPadIcon />} />
                    </div>
                    <div className="w-full py-8 md:py-0">
                        <FeatureCard title="Booking Keeping" icon={<MagicBookIcon />} />
                    </div>
                    <div className="w-full py-8 md:py-0">
                        <FeatureCard title="Equipment Tracking" icon={<EquipmentIcon size={48} className="text-blue-500/70" />} />
                    </div>
                </div>
            </div>
        </div>
