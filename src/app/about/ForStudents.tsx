            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-center md:justify-around gap-0 md:gap-12 divide-y md:divide-y-0 divide-slate-100">
                    <div className="w-full md:w-1/3 max-w-sm mx-auto py-12 md:py-0">
                        <FeatureCard title="Live Synchronization" icon={<SatelliteIcon />} />
                    </div>
                    <div className="w-full md:w-1/3 max-w-sm mx-auto py-12 md:py-0">
                        <FeatureCard title="Explore School" link="/discover" icon={<LighthouseIcon />} />
                    </div>
                </div>
            </div>
        </div>
...
function LighthouseIcon() {
    return (
        <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <path
                d="M12 2v1M12 21v1M4.22 4.22l.707.707M19.07 19.07l.707.707M2 12h1M21 12h1M4.22 19.78l.707-.707M19.07 4.93l.707-.707"
                strokeWidth={1}
                opacity={0.5}
            />
        </svg>
