...
export const CSV_DATA = {
    school: {
        title: "Schools",
        icon: AdminIcon,
        description: "Manage your administration with precision. Example data structure for school registry.",
    ...
    packages: {
        title: "Packages",
        icon: PackageIcon,
        description: "Flexible pricing and lesson bundles. Structure for service offerings.",
    ...
    equipments: {
        title: "Equipments",
        icon: EquipmentIcon,
        description: "Track inventory and assets. Standardized equipment data format.",
        ...
        rows: [
            ...
            [
                ...
                "North", "Reach", 12, "Green", "NTH-RCH-12"
            ],
            [
    ...
    students: {
        title: "Students",
        icon: HelmetIcon,
        description: "Client database management. Full profile for diverse international operations.",
    ...
    teachers: {
        title: "Teachers",
        icon: HeadsetIcon,
        description: "Instructor profiles and credentials. Comprehensive data for payroll and scheduling.",
