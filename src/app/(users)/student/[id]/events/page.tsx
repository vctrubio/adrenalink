...
export default async function StudentEventsPage({ params }: StudentEventsPageProps) {
    ...
    if (!result.success) {
        return <div className="p-4 rounded-lg bg-destructive/10 border border-destructive text-destructive">Error: {result.error}</div>;
    }
    ...
    return (
        <div>
            ...
            get all events and show via eventstudentcard
