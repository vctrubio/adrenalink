...
function SignOutButton() {
    ...
    return (
        <button
            onClick={() => signOut()}
            className="w-full px-8 py-3 bg-destructive text-destructive-foreground rounded-lg font-medium hover:bg-destructive/90 transition-colors"
        >
            Sign Out
        </button>
    );
...
function UserInfo() {
    ...
    return (
        <div className="p-4 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg">
            <p className="text-sm text-green-900 dark:text-green-100 font-semibold mb-2">✓ Authenticated</p>
            <p className="text-xs text-green-800 dark:text-green-200 mb-3">
                User ID: <code className="bg-green-100 dark:bg-green-900 px-2 py-1 rounded">{userId}</code>
            </p>
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-4 py-16 md:py-32">
            <div className="w-full max-w-4xl mx-auto">
                ...
                {/* Route Info */}
                <div className="text-center mb-12 p-4 bg-card rounded-lg border border-border shadow-sm">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground mb-4">
                                    Clerk's authentication components (<code className="bg-muted px-1 py-0.5 rounded text-xs">SignIn</code>, <code className="bg-muted px-1 py-0.5 rounded text-xs">SignUp</code>, etc.) manage their own routing internally. They require a catch-all route to handle their internal navigation and modal flow.
                                </p>
                            </div>

                            <div className="p-4 bg-muted/50 rounded-lg border border-border">
                                <h3 className="font-semibold text-foreground mb-2">File Structure</h3>
                                <code className="block text-xs text-muted-foreground font-mono bg-background p-3 rounded">
{`src/app/auth/
...
└── [[...rest]]/
    └── page.tsx         (Catch-all route for Clerk)`}
                            ...
                            <div className="p-4 bg-muted/50 rounded-lg border border-border">
                                <h3 className="font-semibold text-foreground mb-2">Alternative (Without Catch-All)</h3>
                                <p className="text-xs text-muted-foreground mb-2">If using simple <code className="bg-muted px-1 py-0.5 rounded">src/app/auth/page.tsx</code>:</p>
                                <code className="block text-xs text-muted-foreground font-mono bg-background p-3 rounded overflow-auto">
{`// Would show error:
...
The '/auth' route is not a catch-all route."`}
                    ...
                    <div className="bg-card border border-border rounded-lg p-8 shadow-sm">
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-muted/50 rounded-lg">
                                <h3 className="font-semibold text-foreground mb-2">Current Providers</h3>
                    ...
                    <div className="bg-card border border-border rounded-lg p-8 shadow-sm">
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <h3 className="font-semibold text-foreground mb-3">Live Sync Features</h3>
                                <ul className="space-y-2 text-sm text-muted-foreground">
                                    <li className="flex gap-2">
                                        <span className="text-primary">•</span>
                                        <span>
                            ...
                            <div>
                                <h3 className="font-semibold text-foreground mb-3">State Management</h3>
                                <ul className="space-y-2 text-sm text-muted-foreground">
                                    <li className="flex gap-2">
                                        <span className="text-accent">✓</span>
                                        <span>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 dark:from-purple-950/30 to-purple-50/50 dark:to-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-8 shadow-sm">
...
CREATE TABLE school_users (
  ...
  entity_id UUID -- references student.id or teacher.id
);`}
                                </code>
                            </div>
  ...
  // 4. Return user profile
                            ...
                            <div className="p-4 bg-purple-50/50 dark:bg-purple-900/20 rounded-lg border border-purple-100 dark:border-purple-800">
                                <h3 className="font-semibold text-purple-900 dark:text-purple-100 mb-3">Next Steps</h3>
                    ...
                    <div className="bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/30 rounded-lg p-8 shadow-sm">
                        ...
                        <div className="space-y-4">
                            ...
                            <SignedIn>
                                <UserInfo />
                                <div className="p-4 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg">
                                    <p className="text-sm text-blue-900 dark:text-blue-100 font-semibold mb-2">📍 Next Step</p>
                                ...
                                <div className="flex flex-col gap-3 sm:flex-row">
                                    <Link
                                        href="/"
                                        className="flex-1 px-8 py-3 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors text-center"
                                    >
                                        Select School & Role
                                    </Link>
                                    <SignOutButton />
                        ...
                        <div className="pt-6 border-t border-border mt-6">
                            <Link
                                href="/"
                                className="inline-flex px-8 py-3 bg-accent text-accent-foreground rounded-lg font-medium hover:bg-accent/90 transition-colors"
                            >
                                Back to Home
                            </Link>
                        </div>
