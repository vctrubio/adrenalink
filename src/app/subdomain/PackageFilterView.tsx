...
const PackageTableHeader = ({
    ...
    handleSort: (column: SortByFilter) => void;
    packageTypeFilter: PackageTypeFilter;
}) => (
    <motion.div
...
const PackageSummaryStep = ({
    ...
    pkg: SchoolPackageType & { bookingCount: number };
    categoryConfig: EquipmentCategoryConfig;
    pricePerHour: number;
    ...
    <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
        ...
        <div className="px-6 pb-6 space-y-3">
            <StudentInfoStep
                ...
                isStudentInfoComplete={studentName && studentEmail}
            ...
            <BookingDatesStep
                ...
                isDatesComplete={dateStart && dateEnd}
