...
export function SubDomainHomePage({ school, assets }: SubDomainHomePageProps) {
    ...
    return (
        <div className="h-screen bg-background flex flex-col items-center p-4 md:p-8 overflow-hidden">
            ...
            <div className="w-full max-w-7xl flex-1 bg-card border border-border rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col relative">
                ...
                {/* 2. Profile Info Bar */}
                <div className="relative px-6 md:px-10 pb-8 bg-muted dark:bg-[#0a0a0a] border-t border-border shrink-0"> 
                            ...
                            <div className="flex flex-wrap justify-center md:justify-start gap-2">
                                {categoryList.map(cat => {
                                    ...
                                    return (
                                        <span 
                                            key={cat}
                                            className="px-3 py-1 rounded-lg text-[10px] md:text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 bg-muted dark:bg-white/10 text-foreground/80 border border-border"
                                        >
                ...
                <div className="flex-1 bg-background/30 backdrop-blur-3xl overflow-y-auto custom-scrollbar flex flex-col items-center justify-center p-10 border-t border-border">
