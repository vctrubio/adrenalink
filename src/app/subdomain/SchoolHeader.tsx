...
function SchoolDefaultAvatar() {
    return (
        <div className="relative -mt-16 md:-mt-20">
            <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden shadow-lg bg-tertiary flex items-center justify-center">
                <AdranlinkIcon className="text-white" size={80} />
            </div>
        </div>
    );
}
...
function SchoolCategories({ categories }: { categories?: string | null }) {
            ...
            <div className="relative bg-background">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row md:items-end gap-6 pb-6">
                        ...
                        <div className="flex-1 min-w-0 pt-2 md:pt-0 space-y-3">
