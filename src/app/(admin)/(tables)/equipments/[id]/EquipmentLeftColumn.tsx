...
export function EquipmentLeftColumn({ equipment }: EquipmentLeftColumnProps) {
    ...
    const equipmentCardData: LeftColumnCardData = {
        name: equipmentName,
        status: <EquipmentStatusLabel status={equipment.schema.status as EquipmentStatus} onStatusChange={handleStatusChange} />,
        avatar: (
    ...
    return (
        <>
            <EntityLeftColumn cards={[equipmentCardData, teachersCardData, studentsCardData, rentalsCardData, repairsCardData]} />
