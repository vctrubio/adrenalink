                ...
                <div className="flex items-center gap-8 text-sm">
                    ...
                    <div className="hidden md:flex items-center gap-4 text-muted-foreground text-xs font-mono">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span>
                                1P:<span className="text-foreground ml-0.5">{getHMDuration(controller.durationCapOne)}</span>
                            </span>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5">
                            <Users size={12} className="opacity-50" />
                            <span>
                                2P:<span className="text-foreground ml-0.5">{getHMDuration(controller.durationCapTwo)}</span>
                            </span>
                        </div>
                        <div className="w-px h-3 bg-border/50" />
                        <div className="flex items-center gap-1.5">
                            <Users size={12} className="opacity-50" />
                            <span>
                                3+:<span className="text-foreground ml-0.5">{getHMDuration(controller.durationCapThree)}</span>
                            </span>
                        </div>
                    </div>
