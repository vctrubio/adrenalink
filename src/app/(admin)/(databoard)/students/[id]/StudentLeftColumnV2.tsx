...
interface StudentLeftColumnV2Props {
  student: StudentModel;
}

export function StudentLeftColumnV2({ student }: StudentLeftColumnV2Props) {
  ...
  return (
    <EntityLeftColumn
      header={`Student ${student.updateForm.firstName} ${student.updateForm.lastName}`}
