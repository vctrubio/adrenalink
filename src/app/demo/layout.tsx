            ...
            <nav className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-8">
                        <Link href="/demo" className="text-sm font-black uppercase tracking-widest text-foreground hover:text-primary transition-colors">
                            Demo
                        </Link>
                        <div className="h-4 w-px bg-border" />
                        <div className="flex items-center gap-6">
                            <Link href="/demo" className="text-xs font-medium text-muted-foreground hover:text-foreground transition-colors">
                                Dashboard
                            </Link>
                            <Link href="/demo/users" className="text-xs font-medium text-muted-foreground hover:text-foreground transition-colors">
                                Users
                            </Link>
                        </div>
                    </div>
