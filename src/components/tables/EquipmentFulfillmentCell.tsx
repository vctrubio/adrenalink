...
import HeadsetIcon from "@/public/appSvgs/HeadsetIcon"; // Added missing import
...
export function EquipmentFulfillmentCell({
    ...
    useEffect(() => {
        if (isOpen && availableEquipment.length > 0) {
            // console.log(`[EquipmentFulfillmentCell] 🔍 Checking preferred gear for ${teacherUsername}`);
        }
    }, [isOpen, availableEquipment, teacherUsername]);
