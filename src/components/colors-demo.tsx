    ...
    return (
        <div className="w-full max-w-6xl mx-auto space-y-8">
            ...
            <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Note: Primary and Tertiary swap in dark mode</p>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-6 bg-primary rounded-lg border border-border">
                        <p className="text-white font-semibold mb-1">Primary</p>
                        <p className="text-white/80 text-sm">Green in light</p>
                        <p className="text-white/80 text-sm">Peach in dark</p>
                    </div>
                    <div className="p-6 bg-secondary rounded-lg border border-border">
                        <p className="text-white font-semibold mb-1">Secondary</p>
                        <p className="text-white/80 text-sm">Blue accent</p>
                    </div>
                    <div className="p-6 bg-tertiary rounded-lg border border-border">
                        <p className="text-gray-800 dark:text-white font-semibold mb-1">Tertiary</p>
                        <p className="text-gray-700 dark:text-white/80 text-sm">Peach in light</p>
                        <p className="text-gray-700 dark:text-white/80 text-sm">Green in dark</p>
                    </div>
                    <div className="p-6 bg-destructive rounded-lg border border-border">
                        <p className="text-white font-semibold mb-1">Destructive</p>
                        <p className="text-white/80 text-sm">Error/danger</p>
                    </div>
                </div>
            </div>
