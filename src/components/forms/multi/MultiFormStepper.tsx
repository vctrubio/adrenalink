                        ...
                        return (
                            <div key={step.id} className="flex items-center flex-shrink-0">
                                ...
                                >
                                    ...
                                    <span className={`text-xs md:text-sm transition-all duration-200 whitespace-nowrap ${
                                        active 
                                ...
                                {!isLast && (
                                    <div className={`h-0.5 md:h-1 w-2 md:w-8 mx-0.5 md:mx-2 rounded-full transition-all duration-300 ${
