            ...
            {showDayCounter && (
                <div className="flex items-center justify-center space-x-4">
                    ...
                    <span className="text-sm font-medium text-foreground px-2">
                        {daysDifference === 0 ? "One Day" : `${daysDifference + 1} day${daysDifference + 1 !== 1 ? "s" : ""}`}
                    </span>

                    <button type="button" onClick={incrementEndDate} disabled={disabled} className="btn-round-outline btn-round-sm">
                        + 1 Day
                    </button>
                </div>
            )}
