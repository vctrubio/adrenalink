    ...
    return (
        <div className={`flex items-center gap-2 ${className}`}>
            ...
            <div className="flex flex-col justify-center">
                <span className="text-[10px] font-bold uppercase tracking-widest leading-none opacity-60">Start</span>
                <span className="text-sm font-bold mt-1 leading-none whitespace-nowrap opacity-80">+{getHMDuration(duration)}</span>
            </div>
        </div>
    );
}
