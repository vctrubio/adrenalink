...
export function DragSortList<T extends DragSortItem>({ items, onReorder, renderItem, className = "" }: DragSortListProps<T>) {
    ...
    return (
        <Reorder.Group axis="y" values={sortedItems} onReorder={handleReorder} className={className}>
