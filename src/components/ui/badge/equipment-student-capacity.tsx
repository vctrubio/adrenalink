            ...
            <div className="flex items-center gap-1">
                {equipmentCapacity > 0 && (
                    <>
                        ...
                        {equipmentCapacity > 1 && <p className="text-sm font-medium text-foreground">{equipmentCapacity}</p>}
                ...
                {studentCapacity > 1 && <p className="text-sm font-medium text-foreground">{studentCapacity}</p>}
            </div>
        </div>
    );
}
