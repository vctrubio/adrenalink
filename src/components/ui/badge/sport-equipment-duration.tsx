...
export function SportEquipmentDurationBadge({ category, count, durationMinutes, className = "" }: SportEquipmentDurationBadgeProps) {
    ...
    return (
        <div className={`flex items-center gap-3 px-2 py-1 rounded-lg border border-purple-200 dark:border-purple-900/30 bg-purple-50/50 dark:bg-purple-900/10 ${className}`}>
