...
export function DropdownItem({
    ...
    const dropdownContent = (
        <>
            {Icon && (
                <div style={item.color ? { color: item.color } : undefined} className="flex-shrink-0">
...
export function createStudentDropdownItems(students: { id: string; firstName: string; lastName: string }[]): DropdownItemProps[] {
