...
const FOUNDER_DATA = {
    ...
    description: "This Application aims to empower schools operations, making them more efficient, clear and automated.",
    ...
    descriptionSections: [
        ...
        },
        {
            title: "Mission",
            content:
                "After 2 decades in the adrenaline community, I founded this platform to embrace a new level of visibility, connection, and organisation for users. Our mission is to give schools, students, and teachers a unified digital home where lessons, progress, and operations flow effortlessly.",
        },
        {
            title: "Social",
            content:
        ...
        },
        {
            ...
            content:
                "This documentation will guide you through the essential steps required to run your school on Adrenalink. Our system is built to handle every moving part — from student registrations and booking flows to referrals, teacher commissions, and the most requested feature: equipment tracking. ",
        },
        // {
        //     title: "Beta",
